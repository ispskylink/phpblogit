...
<!-- Выборка всех постов из DB -->
<?php $posts = getAllPosts(); ?>
	<title>Admin | Редактор Постов</title>
</head>
<body>
	<!-- admin navbar -->
	...
	<div class="container content">
		...
		<div class="table-div"  style="width: 80%;">
			...
			<?php if (empty($posts)): ?>
				<h1 style="text-align: center; margin-top: 20px;">Нет постов в БД.</h1>
			<?php else: ?>
				<table class="table">
						<thead>
						<th>N</th>
						...
						<th>Заголовок</th>
						<th>Просмотров</th>
						<!-- Только Админ может паблиш/не паблиш посты -->
